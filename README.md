...
This repository contains all of the code for each individual lesson and is broken into _three_ sections- __HTML__, __CSS__, and __Javascript__. Each section contains a folder for each lesson that contains all the code for the project as of the end of that lesson.
